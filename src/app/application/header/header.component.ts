...
constructor(iconRegistry: MatIconRegistry, sanitizer: DomSanitizer,private headerService: HeaderService,
  ...
  private el: ElementRef) {
    ...
    iconRegistry.addSvgIconLiteral('setting', sanitizer.bypassSecurityTrustHtml(this.Setting_Icon));
    iconRegistry.addSvgIconLiteral('user', sanitizer.bypassSecurityTrustHtml(this.user_Icon));

  }

 
  ngOnInit() {
    this.headerService.links$.subscribe((links:any) => {
      this.links = links;
  ...
  //   alert(this.isDropdownOpen);
  // }

  // onOptionClick(option: string) {
  //   if (option === 'Night Mode/Day Mode') {
  //     this.isDarkMode = !this.isDarkMode;
  //   } else {
  //     // Perform other actions for other options (e.g., My Profile, Logout)
